...
if [ ! -d "data_repo" ]; then
    ...
    perl gdown.pl "https://drive.google.com/file/d/1XBZbwgcV1n2AWWAyt2RWfSKKxzssRFBo/view?usp=sharing" data_repo.tar.gz
...
echo export AA_DATA_REPO=/project/shared/DSSR/s229294/hoshida_lab_rnaseq/hbv_fusion/FastViFi/testing/data_repo >> ~/.bashrc
echo export REFERENCE_REPO=$PWD/viral_data >> ~/.bashrc

VIFI_DIR=$VIFI_DIR
AA_DATA_REPO=/project/shared/DSSR/s229294/hoshida_lab_rnaseq/hbv_fusion/FastViFi/testing/data_repo
